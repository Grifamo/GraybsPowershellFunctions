...
$SupportedEditions = @("Office 365 Client Update - Monthly Channel","Office 365 Client Update - Monthly Channel (Targeted) Version","Office 365 Client Update - Semi-annual Channel Version")
